...
export function setupScene({ canvas }) {
  ...
  function getResponsiveGlobeDefaults() {
    const viewportWidth = Math.max(window.innerWidth || 0, 1);
    const viewportHeight = Math.max(window.innerHeight || 0, 1);
    const isMobileViewport = viewportWidth <= 1080;
    const aspectRatio = viewportWidth / viewportHeight;
    ...
    return {
      theta: CAMERA_ANGLED_DEFAULT_THETA,
      phi: THREE.MathUtils.lerp(CAMERA_ANGLED_DEFAULT_PHI, 1.0, portraitTightness),
      radius: CAMERA_GLOBE_DEFAULT_RADIUS * THREE.MathUtils.lerp(1, 0.9, portraitTightness)
    };
  }
  ...
  const responsiveTopdown = getResponsiveGlobeDefaults();
  
  const cameraState = {
    earthModelView: "spherical",
  ...
  const flatStage = new THREE.Group();
  scalableStage.add(flatStage);
  const globeStage = new THREE.Group();
  globeStage.visible = false;
  stage.add(globeStage);
  const globeRuntimeStage = new THREE.Group();
  stage.add(globeRuntimeStage);
  ...
  defaultCameraLookTarget.copy(globeSurface.position);
  ...
  flatStage.add(northSeasonOverlay);
  ...
  flatStage.add(southSeasonOverlay);
  ...
  flatStage.add(analemmaProjection);
  ...
  flatStage.add(analemmaProjectionPoints);
  ...
  flatStage.add(skyAnalemmaPoints);
  ...
  globeRuntimeStage.add(domeRing);
  ...
  globeRuntimeStage.add(walkerGuideGroup);
  ...
  globeRuntimeStage.add(orbitSun);
  ...
  globeRuntimeStage.add(orbitDarkSun);
  ...
  globeRuntimeStage.add(orbitMoon);
  ...
  globeRuntimeStage.add(sunFullTrail);
  ...
  globeRuntimeStage.add(sunFullTrailPointsCloud);
  ...
  globeRuntimeStage.add(sunTrail);
  ...
  globeRuntimeStage.add(sunTrailPointsCloud);
  ...
  globeRuntimeStage.add(moonFullTrail);
  ...
  globeRuntimeStage.add(moonFullTrailPointsCloud);
  ...
  globeRuntimeStage.add(moonTrail);
  ...
  globeRuntimeStage.add(moonTrailPointsCloud);
  ...
  globeRuntimeStage.add(darkSunFullTrail);
  ...
  globeRuntimeStage.add(darkSunFullTrailPointsCloud);
  ...
  globeRuntimeStage.add(darkSunTrail);
  ...
  globeRuntimeStage.add(darkSunTrailPointsCloud);
  ...
  globeRuntimeStage.add(createOrbitTrack(TROPIC_CANCER_RADIUS, 0xffc96c, 0.88, ORBIT_SUN_HEIGHT_NORTH));
  globeRuntimeStage.add(createOrbitTrack(EQUATOR_RADIUS, 0x7fd8ff, 0.78, ORBIT_SUN_HEIGHT));
  globeRuntimeStage.add(createOrbitTrack(TROPIC_CAPRICORN_RADIUS, 0xff93b6, 0.88, ORBIT_SUN_HEIGHT_SOUTH));

  function setEarthModelView(mode = "spherical") {
    const useSphericalView = mode !== "flat";
    cameraState.earthModelView = useSphericalView ? "spherical" : "flat";
    scalableStage.visible = !useSphericalView;
    globeStage.visible = useSphericalView;
    globeRuntimeStage.visible = useSphericalView;
    globeStage.rotation.set(0, 0, 0);
    return cameraState.earthModelView;
  }

  setEarthModelView("spherical");
